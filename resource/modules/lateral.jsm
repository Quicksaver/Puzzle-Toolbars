...
this.lateral = {
	...
	move: function() {
		...
		sscode += '		left: '+(this.style.left -barOffset)+'px;\n';
		sscode += '		clip: rect(0px, '+clipOffWidth+'px, '+this.style.height+'px, '+(clipOffWidth -this.CLIP)+'px);\n';
		sscode += '	}\n';
		
		sscode += '	window['+objName+'_UUID="'+_UUID+'"]:not([customizing="true"]) #'+objName+'-lateral-container[movetoright][autohide] {\n';
		sscode += '		right: '+this.style.right+'px;\n';
		sscode += '	}\n';
		...
		sscode += '		right: '+(this.style.right -barOffset)+'px;\n';
		sscode += '		clip: rect(0px, '+this.CLIP+'px, '+this.style.height+'px, 0px);\n';
		sscode += '	}\n';
		
		sscode += '	window['+objName+'_UUID="'+_UUID+'"] #'+objName+'-lateral-PP:not([movetobottom]):-moz-any(:not([active]),:not([inSidebar])) { top: '+this.style.top+'px; }\n';
		sscode += '	window['+objName+'_UUID="'+_UUID+'"] #'+objName+'-lateral-PP[movetobottom]:-moz-any(:not([active]),:not([inSidebar])) { bottom: '+this.style.bottom+'px; }\n';
		
		sscode += '	window['+objName+'_UUID="'+_UUID+'"] #'+objName+'-lateral-PP:not([movetoright]):not([active]) {\n';
		sscode += '		left: '+(this.style.left +ppOffsetX +OSoffset)+'px;\n';
		sscode += '	}\n';
		sscode += '	window['+objName+'_UUID="'+_UUID+'"] #'+objName+'-lateral-PP:not([movetoright])[active]:not([inSidebar]) {\n';
		sscode += '		left: '+(this.style.left +ppOffsetX +OSoffset +shrunkOffsetHover)+'px;\n';
		sscode += '	}\n';
		sscode += '	window['+objName+'_UUID="'+_UUID+'"] #'+objName+'-lateral-PP:not([movetoright])[active]:not([inSidebar]):not(:hover) {\n';
		sscode += '		left: '+(this.style.left +ppOffsetX +OSoffset +shrunkOffset)+'px;\n';
		sscode += '	}\n';
		...
		sscode += '				left: '+(this.style.left +ppOffsetX +OSoffset +shrunkOffset +1)+'px;\n';
		sscode += '			}\n';
		sscode += '		}\n';
		sscode += '	}\n';
		...
		sscode += '		right: '+(this.style.right +ppOffsetX +OSoffset -21)+'px;\n';
		sscode += '	}\n';
